...
<img src="/assets/marketing/docs/multiple-tokens.png" style={{ width: "75%" }} data-caption="Managing tokens in the server settings" />
...
<img src="/assets/marketing/docs/tokens-empty-modal.png" style={{ width: "75%" }} data-caption="API Tokens Modal" />

Create a token by clicking on the Create Token button. Provide a name for the token and select the desired permissions.

<img src="/assets/marketing/docs/create-dave-token.png" style={{ width: "75%" }} data-caption="Creating an API Token" />

Once created, make sure to copy the token as it will not be shown again.

<img src="/assets/marketing/docs/created-dave-token.png" style={{ width: "75%" }} data-caption="API token created" />
...
<img src="/assets/marketing/docs/edit-token.png" style={{ width: "75%" }} data-caption="Editing an API Token" />
