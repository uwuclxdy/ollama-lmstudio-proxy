...
///
/// Reference: api-docs/ollama/repo/api.md §"Generate a chat completion" (with
/// images): images travel as part of the user turn that submitted them.
...
#[cfg(test)]
#[path = "../../tests/unit/lmstudio_images.rs"]
mod tests;
